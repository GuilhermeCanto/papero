...
export function ThemeBootScript() {
  const persistence = JSON.stringify({
    ...
    avatar_location: PREFERENCE_PERSISTENCE.avatar_location,
  ...
  const defaults = JSON.stringify({
    ...
    avatar_location: PREFERENCE_DEFAULTS.avatar_location,
  ...
  const code = `
    (function () {
      try {
        ...
        var rawAvatarLocation = readPreference("avatar_location", DEFAULTS.avatar_location);
        ...
        var font = validFonts[rawFont] ? rawFont : fontAliases[rawFont] || DEFAULTS.font;
        var contentLayout = rawContentLayout || DEFAULTS.content_layout;
        var avatarLocation =
          rawAvatarLocation === "navbar" || rawAvatarLocation === "sidebar"
            ? rawAvatarLocation
            : DEFAULTS.avatar_location;
        var navbarStyle =
          rawNavbarStyle === "scroll"
            ? "navbar"
            : rawNavbarStyle === "sticky"
              ? "inset"
              : rawNavbarStyle || DEFAULTS.navbar_style;
        ...
        root.setAttribute("data-avatar-location", avatarLocation);
