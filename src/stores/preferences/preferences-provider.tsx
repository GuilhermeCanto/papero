...
import { normalizeFontKey } from "@/lib/fonts/registry";
import {
  AVATAR_LOCATION_VALUES,
...
function readDomState(): Partial<PreferencesState> {
  ...
  return {
    ...
    font: normalizeFontKey(root.getAttribute("data-font")),
    contentLayout: getSafeValue(root.getAttribute("data-content-layout"), CONTENT_LAYOUT_VALUES),
    avatarLocation: getSafeValue(root.getAttribute("data-avatar-location"), AVATAR_LOCATION_VALUES),
...
export const PreferencesStoreProvider = ({
  ...
  avatarLocation: PreferencesState["avatarLocation"];
